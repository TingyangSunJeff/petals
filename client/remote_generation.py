...
class RemoteGenerationMixin(_SkipTokensMixin):
    ...
    def generate(
        ...
        request_id: int = 1,
        routing_path: Optional[List[int]] = None, **kwargs
    ):
        logger.info(f"RemoteGenerationMixin.generate{routing_path}")
        ...
        if session is not None:
            ...
            context_manager = self.inference_session(max_length=session_max_length, request_id=request_id, routing_path=routing_path)
