...
def get_server_throughput(
    ...
    *,
    ...
    throughput_inference = throughput_info["forward_rps"] / average_blocks_used
    ...
    logger.info(f"Reporting inference throughput: {throughput_inference:.1f} tokens/sec compare to network rps {network_rps:.1f} tokens/sec")
