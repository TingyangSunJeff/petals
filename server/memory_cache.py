...
class MemoryCache:
    ...
    async def allocate_cache(
        ...
        logger.info("======> cache size:{}".format(max_alloc_size))
        gib = 1024**3
    ...
    def use_cache(self, *handles: Handle) -> Sequence[torch.Tensor]:
        ...
        report_memory("Before use_cache")
        ...
        while self._pipe_recv.poll():
            ...
            if recv_data is not None:  # create new tensors
                ...
                for handle, descr in zip(recv_handles, recv_data):
                    ...
                    report_memory("After creating new tensors in use_cache")
                ...
                for handle in recv_handles:
                    ...
                    report_memory("After deleting tensors in use_cache")
        report_memory("before yielding tensors in use_cache")
        yield tuple(self._allocated_tensors[handle] for handle in handles)
        report_memory("After yielding tensors in use_cache")
