...
async def iterate_rpc_inference(
    ...
    *,
    ...
    # report_memory("iterate_rpc_inference start")
    ...
    async for request, step_metadata in input_iterator:
        request_received_time = time.time()  # <--- Start timing
        ...
        computation_start_time = time.time()  # <--- Before model forward
        ...
        computation_end_time = time.time()  # <--- After model forward
        ...
        response_ready_time = time.time()  # <--- After serialization
